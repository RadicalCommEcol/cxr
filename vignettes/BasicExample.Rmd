...
We will demonstrate the basic usage of the package, using the data included in it (see Lanuza, Bartomeus, Godoy. 2018 Ecology Letters 21(6) 865-874 for a description of the dataset). In particular, with this dataset, we will obtain the values of seed production in the absence of neighbours and the strength of competitive interactions between pairs of species. Once obtained this information, these are the basis for estimating the degree of niche overlap and average fitness differences between a pair of species. 
