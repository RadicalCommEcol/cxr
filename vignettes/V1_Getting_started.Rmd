...
Note that some interaction coefficients are NA because species do not cooccur but are nevertheless listed as neighbours with densities equal to zero in all focal observations.
