...
First, compile the parameters from the original results, which are in a nested list. We will retrieve the estimates from the most complex model (BH_5), and the optimization method *L-BFGS-B* (see the help of `stats::optim` for details on the optimization method).
