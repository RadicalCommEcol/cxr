...
It is created with the function `build_param`, and populated with the function `generate_vital_rate_coefs`. 
...
The rest of the coefficients can be filled up likewise, for a final set of matrices similar to the ones imported in the main example.
