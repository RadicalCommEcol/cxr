...
#' @param target_all matrix giving which species is calculated with which values. See \code{er_optim}
#' @param density_all matrix giving the densities of each species at each observation. See \code{er_optim}
...
#' @export
model_ER <- function(init.par, lambda, target_all, density_all, log.fitness, covariates = NULL){
