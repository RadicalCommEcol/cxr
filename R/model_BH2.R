...
#' given the model and parameters. model_BH2 is \eqn{F_i = \frac{\lambda_i}{1+\alpha \sum_jN_{j}}}{(lambda_i)/(1 + alpha * sum(N_j))}
#' 
...
#' @param num.covariates not used in model_BH2
#' @param num.competitors not used in model_BH2
#' @param focal.covariates not used in model_BH2.
